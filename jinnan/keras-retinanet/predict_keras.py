...
if __name__ == "__main__":
    ...
    model_path = os.path.join('/home/hywel/Documents/keras-retinanet/model/batchsize_1_3_20/snapshots', 'densenet169_csv_15.h5')

    # load retinanet model
    model = models.load_model(model_path, backbone_name='densenet169')
